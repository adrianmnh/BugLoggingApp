...
import panels.subpanels.CustomScrollPanel;
import runes.Rune;
...
public class SummonersWarAppPanel extends MyPanel {
...
//    public MainFrame PF;
    ...
    private JPanel scroll_panel_container;
...
//        monster_scroll_panel.getHorizontalScrollBar().setUnitIncrement(8);
        ...
        Helper.resize(scroll_panel_container, -1, 137);
...
//        p3.setSelectedIndex(5);
    ...
    public SummonersWarAppPanel(MainFrame f){
        super(f);
...
//        monster_table.setSelectionMode(0);
        ...
        load_runes_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println(scroll_panel.getSize());
                System.out.println(scroll_panel_container.getSize());

//                addAllUserRunes(PF.getCurrentUserID());
...
//            leftScrollPanel = new leftScrollPanel(PF,  left1, left2);
            scroll_panel = new CustomScrollPanel(this,  left1, scroll_panel_container);
//        Helper.resize(scroll_panel, 380, 137);
